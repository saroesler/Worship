			...
			<tbody>
				{foreach from=$churches item='church'}
					<tr>
						...
						<a href="{modurl modname=Worship type=admin func=ChurchDel id=$church->getCid()}" class="z-button">{img src='14_layer_deletelayer.png' modname='core' set='icons/extrasmall'}</a>
						</td>
					</tr>
				{/foreach}
				<tr> 
